...
class MainScreen extends React.Component {
  ...
  post = async () => {
    ...
    if (this.state.image !== null) {
      ...
      //Post 처리
      await axios
        .post("http://192.168.35.1:5000/img_trans",formData, {
          headers: {
    ...
    return (
      <Container>
        ...
        >
          ...
          <Text style={styles.text1}></Text>
          <Text style={styles.text2}>원하시는 사진을 선택해주세요</Text>
          <Text style={styles.text2}>멋진 그림으로 변환해드립니다</Text>
          <Text style={styles.text2}>지금 바로 만들어보세요</Text>
          <Text style={styles.text1}></Text>
